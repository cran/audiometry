...
The package name *audiometry* is obviously much wider then just pure tone audiogram forms. I intend to broaden the package's functionality *slowly* over time. 
